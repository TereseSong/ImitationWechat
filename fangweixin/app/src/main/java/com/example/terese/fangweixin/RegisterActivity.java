...
public class RegisterActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        classinfo=(EditText) this.findViewById(R.id.classinfo);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        httpUrlConnPost(username.getText() + "",
                                password.getText() + "",
                                number.getText()+"",
                                classinfo.getText()+"");
                    }
...
//                startActivity(intent);
    ...
    // 1.编写一个发送请求的方法
    // 发送请求的主要方法
    public void httpUrlConnPost(String name, String password,String number,String classinfo) {
        HttpURLConnection urlConnection = null;
        URL url;
        try {
            // 请求的URL地地址
            url = new URL(
                    "http://192.168.31.135:8080/AndroidService/RegServlet");
            ...
            json.put("classinfo", URLEncoder.encode(classinfo, "UTF-8"));
